...
| `tests/orchestration/` | System contracts: CalibrationSystem, PfabAgent step methods, MPC |
...
- MPC tests are in `TestMPCLookahead` within `test_run_calibration_contracts.py`
